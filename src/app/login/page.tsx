...
export default function Page(){
  ...
  return (<section className="py-16"><Container>
    <div className="max-w-md mx-auto rounded-3xl border p-6 bg-white">
      <h1 className="text-2xl font-extrabold">Вхід</h1>
      <form onSubmit={onSubmit} className="mt-6 space-y-3">
        ...
        <button className="w-full rounded-2xl px-5 py-3 text-sm font-semibold bg-[var(--color-accent)] text-[var(--color-primary)]">Увійти</button>
      </form>
    </div>
  </Container></section>);
}
